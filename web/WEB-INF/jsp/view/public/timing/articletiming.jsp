<template:user_backend htmlTitle="定时发布" bodyTitle="定时发布">
    ...
    <div class="panel-body">
        ...
        <form class="form-inline" role="form" style="float:left;">
            <div class="form-group has-feedback">
                <div class="input-group">
                    ...
                    <input  readonly="readonly" value="${article.id}" id="aid" class="form-control has-success" type="text" placeholder="活动id">
                </div>
                <br>
                <div class="input-group">
                    <div class="input-group-addon">活动标题</div>
                    <input  readonly="readonly"  value="${article.title}" id="title" class="form-control has-success" type="text" placeholder="活动标题">
                </div>
                <br>

                <div class="input-group">
                    <div class="input-group-addon">活动发布者</div>
                    <input  readonly="readonly"  value="${article.name}" id="username" class="form-control has-success" type="text" placeholder="活动标题">
                </div>
                <br>

                <input type="hidden" value="${article.status}" >
                <div class="input-group">
        ...
        <div style="float:left;margin-left: 80px">
            <c:choose>
                <c:when test="${not empty timing.time and article.status==0}">
                        <button  class="btn btn-primary" onclick="edit()" id="timebutton">修改</button>
                </c:when>
                <c:when test="${not empty timing.time and article.status==1}">
