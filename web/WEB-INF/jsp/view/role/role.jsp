    ...
    <div class="col-md-11">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='${cx}/role/add'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
                <br>
                <hr style="clear:both;">
...
<script type="text/javascript">
            ...
            success : function(result) {
                ...
                if ( result.success ) {
                    ...
                    $.each(roles, function(i, role){
                        ...
                        tableContent += '	  <button type="button" onclick="goDelete('+role.id+')"  class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>';
                        tableContent += '  </td>';
                        tableContent += '</tr>';
                    });
    ...
    function goAssignPage(id) {
        window.location.href = "${cx}/role/assign?id="+id;
    }


    function goUpdatePage(id) {
        window.location.href = "${cx}/role/edit?id="+id;
    }
