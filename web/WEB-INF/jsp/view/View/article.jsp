<template:index >
    ...
    <%--&lt;%&ndash;<%@ page import="java.util.Map" %>&ndash;%&gt;--%>
    ...
    <div class="main" style="margin-left: 2em;margin-right: 2em;background-color: white">
        <div class="panel-body" >
            <ol class="breadcrumb" style=";border-radius: 0;color: #004957">
                ...
                <li class="breadcrumb-item"><a href="${cx}/index/activity">活动首页</a></li>
                <li class="breadcrumb-item active" style="color: #000000" >${activity.title}</li>
                <input type="hidden" value="${activity.url}" id="aurl">
                <input type="hidden" value="${activity.title}" id="atitle">
            </ol>
        </div>
    </div>
    <div class="main" style="display: flex;">
        <div class="main-left">
            <div class="one" >
                ...
                <input type="hidden" value="${activity.title}" id="title">
                <div class="title"><strong><h3 style="text-align: center">${activity.title}</h3></strong></div>
                <p style="text-indent:50px;">作者:${activity.name}
    ...
    <div class="main" style="margin-left: 2em;margin-right: 2em;background-color: white">
        ...
        <div class="comment col-sm-12" style="margin-bottom:2em">
            ...
            <div class="form-group" id="">
                <label for="commentData">评论:
                    <b style="margin-left: 60px ;color:#bc656e;">字数限制在200个字符内</b></label>
                <p style="color: #0f5179;margin-left: 40px" id="errormsg"></p>
                ...
                <!--此处显示评论-->
                <div id="commentData" class="comment" ></div>
                <table width="100%" >
                    <tr >
                ...
                <%--<a href="${cx}/view/user?id='+username+'">'--%>
                    $.each(comments, function (i, comment) {
                        if(comment.realname== realname){
                            tableContent += "<div style='padding:10px;background-color: white;margin: 10px 10px;border-radius: 5px;border: 1px black dotted' id='" + comment.id + "'><img style='border:1px solid black;  border-radius: 30px;width:50px' id='img_nav' class='user-pic' src='"+comment.hurl+"' alt='无法显示'/><a href='${cx}/view/user?id="+comment.username+"'>&nbsp;" + comment.username +"</a>&nbsp;<span style='font-size: 14px;font-family: cursive;'>"+ comment.time.substring(0,16) +' '+ "发表:</span><br> &nbsp; &nbsp;" + comment.content + "" + "<br>" +
